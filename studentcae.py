...
def student(username):
    ...
    def acc():
        import accounts
        accounts.mat()
    btnmg = ImageTk.PhotoImage(file=r"files\accounts.png")
    btn=tk.Button(canvas1,font=("Times new roman",30),image=btnmg,command=acc)
    btn.place(x=20,y=190)
    #chemistry button
    def com():
        import commerce
        commerce.mat()
    btmg = ImageTk.PhotoImage(file=r"files\commerce.png")
    btn=tk.Button(canvas1,text="CHEMISTRY",font=("Times new roman",30),image=btmg,command=com)
    ...
    btn=tk.Button(canvas1,text="MATHS",font=("Times new roman",30),image=btg,command=m)
    btn.place(x=730,y=190)
    #bio button
    def eco():
        import Economics
        Economics.mat()
    btni = ImageTk.PhotoImage(file=r"files\economics.png")
    btn=tk.Button(canvas1,text="BIOLOGY",font=("Times new roman",30),image=btni,command=eco)
